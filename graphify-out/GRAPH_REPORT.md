...
## Corpus Check
- 494 files · ~750,588 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7754 nodes · 15726 edges · 415 communities (335 shown, 80 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 504 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f74a879b`
...
5. `AppState` - 75 edges
6. `el()` - 56 edges
7. `Exasol Studio Product Specification` - 45 edges
8. `errorMessage()` - 44 edges
...
## Communities (415 total, 80 thin omitted)
...
### Community 1 - "cn"
Cohesion: 0.03
Nodes (107): Conversation(), ConversationContent(), ConversationContentProps, ConversationEmptyState(), ConversationEmptyStateProps, ConversationProps, ConversationScrollButton(), ConversationScrollButtonProps (+99 more)

### Community 2 - "ipc.ts"
Cohesion: 0.03
Nodes (100): App(), MainApp(), BucketFsPanel(), VirtualSchemaWindow(), InstallWindow(), Action, ACTIONS, Line (+92 more)

### Community 3 - "ExasolParser"
Cohesion: 0.06
Nodes (3): getSuggestions(), parseErrors(), ExasolParser

### Community 4 - "prompt-input.tsx"
Cohesion: 0.02
...
Cohesion: 0.04
Nodes (60): ExasolMark(), defineMonacoThemes(), ExasolStudio(), fmtClock(), HistoryDock(), IconButton(), MAX_ROWS_OPTIONS, parseSingleTable() (+52 more)

### Community 7 - "AiProvidersWindow.tsx"
Cohesion: 0.04
Nodes (58): BRAND_MARK_IDS, BrandMark(), LogoProps, MARKS, McpMark(), AiProvidersWindow(), BehaviorSection(), ChoiceRow() (+50 more)
...
Cohesion: 0.05
Nodes (54): react, ChartConfig, ChartContainer(), ChartContext, ChartContextProps, ChartLegendContent(), ChartTooltipContent(), getPayloadConfigFromPayload() (+46 more)
...
Cohesion: 0.05
Nodes (50): DB_MARK_IDS, DB_MARKS, DbMark(), ResizableHandle(), ResizablePanelGroup(), Select(), SelectContent(), SelectGroup() (+42 more)
...
### Community 17 - "AssistantPanel.tsx"
Cohesion: 0.05
Nodes (55): CodeBlock(), CodeBlockContext, CodeBlockContextType, CodeBlockCopyButton(), CodeBlockCopyButtonProps, CodeBlockProps, highlightCode(), lineNumberTransformer (+47 more)
...
Cohesion: 0.05
Nodes (37): BrandLoader(), ThemeToggle(), AnimatedList, AnimatedListItem(), AnimatedListProps, AnimatedThemeToggler(), AnimatedThemeTogglerProps, getThemeTransitionClipPaths() (+29 more)
...
Cohesion: 0.06
Nodes (39): Input(), SkillsSection(), DashboardsTab(), Panel(), DatabaseInfoPanel(), InfoTable(), meta(), categoryFor() (+31 more)
...
Cohesion: 0.06
Nodes (38): GitLogPane(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuLabel(), DropdownMenuRadioItem(), DropdownMenuSeparator() (+30 more)
...
Cohesion: 0.08
Nodes (25): main(), Artifact, ArtifactStore, AgentConfig, AgentSettings, ConfigStore, DEFAULT_AGENT_SETTINGS, DEFAULT_CONFIG (+17 more)
...
Cohesion: 0.10
Nodes (32): RFC-4180, A2ATask, A2ATaskState, TaskManager, Worker, buildInsert(), buildPlan(), cellToLiteral() (+24 more)
...
Cohesion: 0.10
Nodes (28): ConnectionSection(), ConnectionInfoPanel(), accentFor(), DatabaseTree(), NodeState, Row(), NODE_ICON, NodeKind (+20 more)
...
Cohesion: 0.14
Nodes (20): ThemeCustomizer(), ThemePresetPicker(), applyTheme(), Theme, ThemeContext, ThemeContextValue, ThemeProvider(), TooltipProvider() (+12 more)
...
Cohesion: 0.12
Nodes (9): CUSTOMER_COLUMNS, delay(), history, mockInvoke(), profiles, STATISTICS_OBJECTS, SYS_OBJECTS, LOCAL_SERVERS (+1 more)
...
Cohesion: 0.23
Nodes (20): ColumnMeta, decode_cell(), describe_columns(), execute_sql(), ExecuteResponse, is_result_set_statement(), row_columns(), row_to_json() (+12 more)
...
Cohesion: 0.29
Nodes (17): get_database_info(), get_schema_graph(), hit(), like_literal(), list_data_types(), list_vs_prereqs(), rank(), AppResult (+9 more)
...
## Knowledge Gaps
- **2236 isolated node(s):** `COMMON_DEV_PORTS`, `SOURCE_DIRS`, `PRODUCT_NAMES`, `DESIGN_NAMES`, `FALLBACK_DIRS` (+2231 more)
...
- **Why does `cn()` connect `cn` to `terminal.tsx`, `GitPanel.tsx`, `ipc.ts`, `prompt-input.tsx`, `EditableResultGrid.tsx`, `ExasolStudio.tsx`, `tree-model.ts`, `AiProvidersWindow.tsx`, `Dashboards.tsx`, `Visualizer.tsx`, `modern-screenshot.umd.js`, `NotebookTab.tsx`, `AssistantPanel.tsx`, `file-tree.tsx`, `FloatingPet.tsx`, `utils.ts`, `errorMessage`, `ThemeCustomizer.tsx`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `ExasolLexer` connect `tests/run.ts` to `ExasolParser`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `TableElementContext` connect `TableElementContext` to `ExasolParser`, `ExpressionContext`, `ExasolParserListener`, `modern-screenshot.umd.js`, `ExasolParserVisitor.ts`, `ExasolParserVisitor`, `ExasolParser.ts`, `SchemaQualifiedTableContext`?**
...
- **Should `cn` be split into smaller, more focused modules?**
  _Cohesion score 0.026201868307131466 - nodes in this community are weakly interconnected._
- **Should `ipc.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.03174193548387097 - nodes in this community are weakly interconnected._