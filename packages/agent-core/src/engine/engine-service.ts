...
export class EngineService {
   ...
   */
  /** Public face of restartForConfig — Studio calls it after writing grant
   *  changes (shield SQL classes / tool groups) straight into exa.json. */
  async applyExternalConfigChange(): Promise<void> {
    await this.restartForConfig();
  }
