...
pub const DRIVERS: &[DriverInfo] = &[
    ...
    DriverInfo {
        ...
        description: "Official Python driver — fast HTTP transport & compression. Install from the Marketplace.",
        default_port: 8563,
        kind: "external",
        is_default: false,
    ...
    DriverInfo {
        ...
        description: "Official SQLAlchemy dialect — powers Superset, pandas and Python ORMs.",
        default_port: 8563,
        kind: "external",
        is_default: false,
    ...
    DriverInfo {
        ...
        protocol: "WebSocket (Node/TS)",
        description: "Official Node/TypeScript driver over the native WebSocket protocol.",
        default_port: 8563,
        kind: "external",
        is_default: false,
    ...
    DriverInfo {
        ...
        protocol: "database/sql driver",
        description: "Official Go database/sql driver for Exasol.",
        default_port: 8563,
        kind: "external",
        is_default: false,
    ...
    DriverInfo {
        id: "r",
        name: "R",
        protocol: "R integration (via ODBC/JDBC)",
        description: "Connect R to Exasol using the documented R integration.",
        default_port: 8563,
        kind: "external",
        is_default: false,
        docs_url: "https://docs.exasol.com/db/latest/connect_exasol/drivers/r.htm",
    },
    DriverInfo {
        id: "exarrow-rs",
        name: "exarrow-rs (Arrow / ADBC)",
        protocol: "Arrow / ADBC / native",
        description: "Rust Arrow/ADBC driver for high-throughput data workflows (Exasol Labs).",
        default_port: 8563,
        kind: "external",
        is_default: false,
