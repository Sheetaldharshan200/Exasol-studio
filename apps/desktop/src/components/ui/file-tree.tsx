...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "absolute left-1.5 h-full w-px rounded-md bg-muted-foreground/25 py-3 duration-300 ease-in-out hover:bg-muted-foreground/50 rtl:right-1.5",
        className
      )}
      {...props}
    />
  ...
  (
    ...
    return (
      ...
      >
        ...
        <AccordionPrimitive.Content className="relative h-full text-sm">
