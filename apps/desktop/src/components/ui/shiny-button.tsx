...
>(({ children, className, ...props }, ref) => {
  return (
    ...
    >
      <span
        className="relative flex size-full items-center justify-center gap-2 text-sm tracking-wide text-[rgb(0,0,0,65%)] uppercase dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
