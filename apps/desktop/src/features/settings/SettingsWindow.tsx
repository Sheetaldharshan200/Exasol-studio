  ...
  },
  {
    ...
    controls: [
      ...
      { key: "autoComplete", label: "Auto-completion", type: "toggle" },
      {
        ...
        type: "toggle",
        help: "Underlines what is certainly wrong (an unclosed string, comment or bracket) and what is wrong for this connection (a schema or table it cannot see, a script language the server does not offer).",
      },
      {
        key: "aiGhostText",
