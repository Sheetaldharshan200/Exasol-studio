// Relative-time formatting for the git log surfaces.
//
// Ported from GitDesktop (https://github.com/theBGuy/GitDesktop), src/lib/time.ts.
// Copyright 2026 theBGuy. Licensed under the Apache License, Version 2.0.
...
const UNITS: {
  ...
  { unit: "year", seconds: 365 * 24 * 3600, rollupAt: Number.POSITIVE_INFINITY },
...
/** Whether `formatRelativeTime` can read this date — guards "in NaN years". */
